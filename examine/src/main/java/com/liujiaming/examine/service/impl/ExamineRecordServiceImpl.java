...
import com.liujiaming.examine.entity.PO.*;
import com.liujiaming.examine.mapper.ExamineRecordMapper;
...
public class ExamineRecordServiceImpl extends BaseServiceImpl<ExamineRecordMapper, ExamineRecord> implements IExamineRecordService {
    ...
    * */
        ...
        if (examine != null) {
            if (ListUtil.toList(1, 2, 3, 5, 6, 7, 8, 9, 10, 11, 12).contains(examine.getLabel())) {
                if (examineType == 1 && !isUnusual){
                    ...
                    com.liujiaming.core.feign.examine.entity.ExamineRecordLog examineRecordLog =
                            new com.liujiaming.core.feign.examine.entity.ExamineRecordLog();
     ...
     *
     * @param simpleUser
     * @return com.liujiaming.examine.entity.VO.ExamineFlowDataVO
