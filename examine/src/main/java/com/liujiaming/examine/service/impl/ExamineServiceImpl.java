...
import com.liujiaming.examine.constant.*;
...
import com.liujiaming.examine.entity.PO.*;
import com.liujiaming.examine.entity.VO.*;
import com.liujiaming.examine.entity.PO.*;
import com.liujiaming.examine.mapper.ExamineMapper;
import com.liujiaming.examine.mapper.ExamineRecordLogMapper;
import com.liujiaming.examine.service.*;
import com.liujiaming.examine.constant.*;
import com.liujiaming.examine.entity.VO.*;
import com.liujiaming.examine.service.*;
...
public class ExamineServiceImpl extends BaseServiceImpl<ExamineMapper, Examine> implements IExamineService {
     ...
     * @param examine
     * @param ownerUserId
     * @return java.util.List<com.liujiaming.examine.entity.VO.ExamineFlowVO>
     **/
    ...
    @Override
    public BasePage<com.liujiaming.core.feign.oa.entity.ExamineVO> queryOaExamineList(ExaminePageBO examinePageBo) {
        UserInfo user = UserUtil.getUser();
        ...
        BasePage<com.liujiaming.core.feign.oa.entity.ExamineVO> page = new BasePage<>(basePage.getCurrent(), basePage.getSize(), basePage.getTotal(), basePage.isSearchCount());
        List<com.liujiaming.core.feign.oa.entity.ExamineVO> examineVoList = new ArrayList<>();
        for (ExamineRecord examineRecord : basePage.getList()) {
            Integer typeId = examineRecord.getTypeId();
            if(typeId == null){
                continue;
            }
            com.liujiaming.core.feign.oa.entity.ExamineVO examineVO = oaService.getOaExamineById(typeId).getData();
