package com.liujiaming.tokenService;
 ...
 * @date 2019-01-23
 **/
public class StartTokenServiceAppliction {

    private static final String APP_NAME = "StartTokenService";
    ...
    public static void main(String[] args) throws Exception {
        StartTokenServiceAppliction clusterServer = new StartTokenServiceAppliction();
        clusterServer.init();
        clusterServer.start();
    }
